        ...
        items: [
            {
                ...
                history: ["2026-9-1", "2026-8-1", "2026-7-1", "2026-6-1", "2026-5-1", 
                          "2026-4-1", "2026-3-1", "2026-2-1", "2026-1-1",
            ...
            },
            {
                ...
                name: "顿涅茨克",
                desc: "顿涅茨克防御动态。",
                history: ["2026-9-1", "2026-8-1", "2026-7-1", "2026-6-1", "2026-1-1","2025-9-3"]
            },
            {
                id: "south",
                name: "南方",
                desc: "扎波罗热和第聂伯罗比得罗夫斯克(亚历山德里夫卡)的局势动态。",
                history: ["2026-9-1", "2026-8-1", "2026-7-1", "2026-6-1","2026-1-1","2025-11-1" ]
            }
        ]
    },
    {
        ...
        items: [
            {
                ...
                history: ["2026-9-14",
                          "2026-9-1", "2026-8-15", "2026-8-1", "2026-7-16", 
                          "2026-7-8", "2026-7-1", "2026-6-28", "2026-6-24",
            ...
            },
            {
                ...
                history: ["2026-9-14","2026-9-1", "2026-8-15", "2026-8-1", 
                          "2026-7-16","2026-7-1", "2026-6-16","2026-6-1", 
            ...
            },
            {
                ...
                history: ["2026-9-14","2026-9-1", "2026-8-15", 
                          "2026-8-1", "2026-7-16","2026-7-1", "2026-6-16",
                          "2026-6-1", "2026-5-1", "2026-4-1", "2026-3-1"]
            }
        ]
    },
    {
        ...
        items: [
            {
                ...
                history: ["2026-9-11", "2026-7-11", "2026-7-6", "2026-6-29", "2026-6-5"]
            },
            {
                id: "Oleksandrivka",
                name: "亚历山德里夫卡",
                desc: "或叫第聂伯罗比得罗夫斯克方向，不定期更新。联合快速反应部队（突击部队）、20军团、8快速反应军团、9军团部署在该方向。",
                history: ["2026-8-13","2026-7-18", "2026-7-6", "2026-7-4", "2026-6-26", "2026-6-15", "2026-6-5"]
            },
            {
                id: "Zaporizhzhia",
                name: "扎波罗热",
                desc: "扎波罗热州战场态势图，17军为当地的主要防御军团。不定期更新。",
                history: ["2026-9-3", "2026-7-16", "2026-7-15", "2026-7-14", "2026-7-2", "2026-6-27", "2026-6-17", "2026-6-11", "2026-6-5"]
            },
            {
                id: "Lyman",
                name: "红利曼",
                desc: "红利曼周边战场态势图。防守此区域的军团为3军团。不定期更新。",
                history: ["2026-9-8", "2026-9-5","2026-8-27", "2026-8-13", "2026-7-11", "2026-7-6", "2026-7-4", "2026-7-2",  "2026-6-26", "2026-6-14", "2026-6-11"]
            },
            {
                id: "Kupiansk",
                name: "库普扬斯克",
                desc: "库普扬斯克周边战场态势图，10军和2军下属的搜打集群部署在该地。不定期更新该方向的局势。",
                history: ["2026-9-5", "2026-9-5", "2026-8-11", "2026-7-8", "2026-7-1", "2026-6-26"]
            },
            {
                id: "Dobropillia",
                name: "多布罗皮利亚",
                desc: "多布罗皮利亚方向的态势图。7快速反应军团和1亚速军团部署在该方向。不定期更新该方向的局势。",
                history: ["2026-9-1", "2026-8-11", "2026-7-3"]
            },
            {
                id: "Sumy",
                name: "苏梅市",
            ...
            },
            {
                id: "VelykyiBurluk",
                name: "大布尔卢克",
                desc: "哈尔科夫州边境东北角，16军团以及14军团的部分兵力部署在该地。不定期更新该方向的局势。",
                history: ["2026-9-11", "2026-8-5",  "2026-7-31"]
            }
        ]
    },
    {
        ...
        items: [
            {
                ...
                history: ["2026-7-21", "2026-7-20", "2026-7-4", "2026-6-20", "2026-6-8", "2026-6-7", "2026-6-6", "2026-3-24"]
            }
        ]
    }
];
