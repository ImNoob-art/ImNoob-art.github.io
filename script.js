        ...
        items: [
            {
                ...
                history: ["2026-6-28", "2026-6-24", "2026-6-20", "2026-6-16","2026-6-12","2026-6-8","2026-6-4", "2026-6-1", "2026-5-29", "2026-5-16", 
            ...
            },
            {
                ...
                history: ["2026-6-16","2026-6-1", "2026-5-16", "2026-4-18", "2026-2-2", "2025-1-1", "2024-10-1", "2024-8-1", "2024-6-1", "2024-1-1"]
            },
            {
                id: "UAzhong",
                name: "兵力密度 乌军 (10km)",
            ...
            },
            {
                ...
                history: ["2026-6-16","2026-6-1", "2026-5-1", "2026-4-1", "2026-3-1"]
            }
        ]
    },
    {
        ...
        items: [
            {
                ...
                history: ["2026-6-23","2026-6-14","2026-6-12","2026-6-7","2026-6-5"]
            },
            {
                id: "Oleksandrivka",
                name: "亚历山德里夫卡",
                desc: "或叫第聂伯罗比得罗夫斯克方向。不定期更新该方向的局势。",
                history: ["2026-6-26", "2026-6-15", "2026-6-12", "2026-6-5"]
            },
            {
                id: "Zaporizhzhia",
                name: "扎波罗热",
                desc: "扎波罗热州战场态势图。不定期更新该方向的局势。",
                history: ["2026-6-27", "2026-6-17", "2026-6-11", "2026-6-5"]
            },
            {
                id: "Lyman",
                name: "红利曼",
                desc: "红利曼周边战场态势图。不定期更新该方向的局势。",
                history: ["2026-6-26", "2026-6-14","2026-6-11"]
            },
            {
                id: "Kupiansk",
                name: "库普扬斯克",
        ...
        items: [
            {
                ...
                history: ["2026-6-20", "2026-6-8","2026-6-7","2026-6-6", "2026-3-24"]
            }
        ]
    }
];
